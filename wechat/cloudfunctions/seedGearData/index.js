...
const { MODELS_DATA, MODELS_DATA_RODS, MODELS_DATA_SPIN_POWER, MODELS_DATA_AXELSPIN, MODELS_DATA_FLIEGEN, MODELS_DATA_SURF_LANDER_JOINT, MODELS_DATA_SURF_LANDER_TELE, MODELS_DATA_SURF_GAZER_CN, MODELS_DATA_SURF_CHASER_CN } = require('./data/models');

// 合并渔轮 + 渔竿数据
const ALL_SERIES = [...SERIES_DATA, ...SERIES_DATA_RODS];
const ALL_MODELS = [...MODELS_DATA, ...MODELS_DATA_RODS, ...MODELS_DATA_SPIN_POWER, ...MODELS_DATA_AXELSPIN, ...MODELS_DATA_FLIEGEN, ...MODELS_DATA_SURF_LANDER_JOINT, ...MODELS_DATA_SURF_LANDER_TELE, ...MODELS_DATA_SURF_GAZER_CN, ...MODELS_DATA_SURF_CHASER_CN];
